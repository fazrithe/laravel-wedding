            ...
            $session = \Stripe\Checkout\Session::create([
              ...
              'line_items' => [[
                'price_data' => [
                  ...
                  'unit_amount' =>  round(convert_currency(get_company_field($data['invoice']->company_id, 'currency','IDR'), get_company_field($data['invoice']->company_id, 'stripe_currency','USD'), ($amount * 100))),
                  'currency'    =>  get_company_field($data['invoice']->company_id, 'stripe_currency','IDR'),
                ],
                'quantity' => 1,
              ]],
              'mode' => 'payment',
